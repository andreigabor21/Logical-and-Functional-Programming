...
(defun count_even(l level)
    (cond
        ((atom l) (mod (1+ level) 2))
        ;((listp l) (apply '+ (mapcar ' count_even l (+ level 1))))
        ((listp l) (apply '+ (mapcar #' (lambda (a) (count_even a (+ 1 level))) l)))
    )
)

(print (count_even ' (a (b (d (e))) (c)) 0))

(print (apply '+ '(3 6 9 12) ) )
